...
async function crear(req, res) {
  try {
    const reportes = await db.getCollection("reportes");
    const eventos = await db.getCollection("eventos");
    ...
    reporte.eventoId = nuevoEvento.id;  
    reportes.push(reporte);
    eventos.push(nuevoEvento);
    
    await db.setCollection("reportes", reportes);
    await db.setCollection("eventos", eventos);
